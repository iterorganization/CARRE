...
!    1-2 et une courbe parametrisee de n points de coordonnees vx vy.
...
!   iint: tableau des indices de segment de la courbe v pour lesquels il
!         y a intersection
!   nint: nombre d'intersections
!   sens: sens du balayage
!.. determ: determinant de la matrice des deux equations.
!.. mult1: facteur multiplicatif du segment 1-2
!.. mult2: facteur multiplicatif du segment de la courbe v.
!=========================
