...
!.. nbcrb: number of the limiting curves.
...
!dps-20051115 The following logical expressions were previously combined into a single
!*** one below.  Separated them and replaced their effective value with trvers2 to
!*** prevent an unintended call to trvers.
...
!dps-20051115 Part of the above change.
