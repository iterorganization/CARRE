...
!*** This sub-routine finds, in the case of a disconnected double null,
!*** the point on the loop of the inner separatrix where it should be
...
!       presently used is considered to be the best one in practice.
...
!.. nn1    : number of these points
!.. pas    : radial steps (distances or psi values) for the surfaces
!..          between the inner and outer separatrices
!.. nppol  : number of grid points between the X-points in poloidal
!..          direction
!.. nprad  : number of grid surfaces between the inner and outer
!..          separatrices
!.. plaque : index of the leading target
!.. [xy]ext: co-ordinates of the strike point of the outer separatrix
!..            on the leading target
!.. [xy]ptxex: coordinates of the outer X-point
!.. [xy]pto: coordinates of the O-point
!.. x,y    : coordinates of the grid on which the psi values are given
!.. nx,ny  : their dimensions
!.. psi    : psi values
!.. nstruc : number of the structures
!.. npstru : numbers of segments in the structures
!.. [xy]struc: coordinates of the structure corners
!.. a00..a11: interpolation coefficients for psi
!.. repart : selector of the radial grid distribution (1=l, 2=psi)
!.. [xy]crb2: points of parametrised outer separatrix
!.. npcrb2 : number of these points

!*** Output
!.. boucl[xy]: coordinates of the splitting point on the separatrix
!..            loop (???)
...
!c<<<
!      if(l_dbg) then
!        write(0,'(8h ---- ir,2a7,a9,4a12)')
!     -                          'ianc','inouv','ll','x1','x2','y1','y2'
...
!c<<<
!          write(0,'(2x,3a7,a9,3a12)') 'chgdir','inouv','ianc',
!     ,                           'xn(o)','yn(o)','xn(a)','yn(a)'
!          write(0,'(1x,l7,2i7,1p,4e12.4)') lc,
...
!     ,                'plaque','npstru','inouv','xn1','yn1','xn2','yn2'
!               write(0,'(1x,2l7,4i7,1p,4e12.4)') li,lc,ind,plaque,
!     ,                    npstru(plaque),inouv,xn(1,inouv),yn(1,inouv),
