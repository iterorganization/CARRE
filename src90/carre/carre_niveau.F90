...
!!$     &        xstruc,ystruc,indstr,xt,yt,nt,nbcrb,plaque,x0,y0)
  ...
  SUBROUTINE CRBNIV( &
       & ii,jj,k,idir,& ! nxmax, nymax
       & nx,ny,x,y,f,niv, & 
       & crbx,crby,& !npnimx, strumx, npstmx
       & nstruc,npstru, & 
...
50  CONTINUE ! the code jumps here if it found a continuation of the level
    ! line that does not intersect one of the limiting curves
