     ...
     &                                                     nxmax,nymax)
!
!  version : 24.06.98 14:45
!
!======================================================================
!*** This routine apparently creates the "guard cells" around the mesh
!======================================================================
      implicit none
!
!  arguments
...
!***
!       print*,'ix=',ix
!       print*,crx(ix,-1,0),crx(ix,-1,1)
!       print*,crx(ix,-1,2),crx(ix,-1,3)
!       print*,crx(ix,ny,0),crx(ix,ny,1)
!       print*,crx(ix,ny,2),crx(ix,ny,3)
!***
...
!         do iy=-1,ny
!           write(6,*)'ix, iy=',ix,iy
!           write(6,404)crx(ix,iy,2),cry(ix,iy,2),crx(ix,iy,3),
!    .        cry(ix,iy,3)
!           write(6,404)crx(ix,iy,0),cry(ix,iy,0),crx(ix,iy,1),
!    .        cry(ix,iy,1)
!404        format(1x,2f10.6,5x,2f10.6)
!         enddo
!       enddo
!***
      return
