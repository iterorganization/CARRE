...
${OBJDIR}/b2mod_switches.${MOD}: ${B2SRC}/modules/b2mod_switches.F
	@mkdir -p ${SRCDIR}/b25_links/
...
${OBJDIR}/b2us_map.${MOD}: ${B2SRC}/modules/b2us_map.F
	@mkdir -p ${SRCDIR}/b25_links/
